...
// Add your code here
var correctFlavor   = (flavor === "vanilla" || flavor === "chocolate");
var correctVessel   = (vessel === "cone" || vessel === "bowl");
var correctToppings = (toppings === "sprinkles" || toppings == "peanuts");

if (correctFlavor && correctVessel && correctToppings)
